...
class Studiocamp(ControlSurface):
    def __init__(self, c_instance):
        super(Studiocamp, self).__init__(c_instance)
        self.log_message("Starting Studiocamp " + version + "...")
        ...
        self.handlers = {
            ...
            "drum_pad": DrumPad(c_instance, self.socket),
        }
    ...
    def disconnect(self):
        ...
        super(Studiocamp, self).disconnect()
    ...
    def command_handler(self, payload):
        ...
        if namespace in self.handlers:
            ...
            self.socket.send("error", "No handler for namespace ANDERS" +
